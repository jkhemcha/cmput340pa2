...
% Approximation
approximation_coefficient_vector_X1 = func_fit(X1, Y1, "approximate", "poly", 10);
approximation_evaluation_X1 = polyval(flip(approximation_coefficient_vector_X1)', X1);

approximation_coefficient_vector_X2 = func_fit(X2, Y2, "approximate", "poly", 50);
...
hold on
scatter(X1, Y1, "blue")
plot(X1, interpolation_evaluation_X1, "red")
...
hold on
scatter(X3, Y3, "blue")
plot(X3, interpolation_evaluation_X3, "red")
plot(X3, approximation_evaluation_X3, "green")
hold off